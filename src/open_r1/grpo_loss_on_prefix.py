...
from mrt_trainer import MRTTrainer
...
def main(script_args, training_args, model_args):
    ...
    def process_dataset(example):
        ...
        return {
            ...
            "current_reward": example["current_reward"],
            "prefix_with_loss": example["prefix_with_loss"],
        }

    processed_dataset = dataset.map(process_dataset, remove_columns=["messages", "problem"])
